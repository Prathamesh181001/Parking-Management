...
def add_vehicle(request):
    choice = ['1', '0', 100, 150, 'Accomodation Fee', 'Verified All Spare', 50]
...
class GeneratePdf(ListView):
    def get(self, request, pk, *args, **kwargs):
        ...
        "data": {
            ...
            'order_id': 1233434,
            'location': 'Regus, Skye One Unit No 101',
            'address': 'First Floor, Kalyani Nagar Pune - 411006',
            'email': 'info@numetry.in',
        },
        "infos": infos,
        }
